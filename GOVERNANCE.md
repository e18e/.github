...
Members can voluntarily leave their role in the community at any time. See [Retiring a Role](#retiring-a-role-alumni) below for more information.
...
**Alumni** is a special designation for members who have retired from their role. See [Retiring a Role](#retiring-a-role-alumni) below for more information.
...
Inspired by the [Astro governance document](https://github.com/withastro/.github/blob/main/GOVERNANCE.md).
